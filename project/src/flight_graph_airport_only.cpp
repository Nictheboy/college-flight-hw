...
FlightGraphAirportOnly::DiscreteChildrenOf(FlightNodeKey node) const {
...
bool FlightGraphAirportOnly::IsContinuousChild(FlightNodeKey parent, FlightNodeKey child) const {
    return false;
}